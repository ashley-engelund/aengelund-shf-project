...
ActivityLogger.open(SEEDING_LOG_FILE_NAME, SEEDING_LOG_FACILITY, 'Init') do |log|
  unless ENV['SHF_MEMBERSHIP_GUIDELINES_CHECKLIST_REQD_START']
    ENV['SHF_MEMBERSHIP_GUIDELINES_CHECKLIST_REQD_START'] = Time.zone.tomorrow.to_s

    log.warn("****************************************************************************")
    log.warn("Using default for SHF_MEMBERSHIP_GUIDELINES_CHECKLIST_REQD_START: yesterday")
