Feature: Company index page has meta information set
  ...
  Scenario: The page has title, description, keywords, og, and twitter meta info set
    ...
    And the page head should include meta "name" = "description" with content "Hitta ett etiskt svenskt hundföretag som har tjänat H-märkt. Hitta en hundinstruktör, Hundbolaget, hundens entreprenör."
    And the page head should include meta "name" = "keywords" with content "hund, hundägare, hundinstruktör, hundens entreprenör, hundbolaget, sveriges hundföretagare, svenskt hundföretag, etisk, h-markt, ansvarig, tjänat h-marknaden, rehab"
    ...
    And the page head should include meta "property" = "og:description" with content "Hitta ett etiskt svenskt hundföretag som har tjänat H-märkt. Hitta en hundinstruktör, Hundbolaget, hundens entreprenör."
