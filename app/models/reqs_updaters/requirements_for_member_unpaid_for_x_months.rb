#--------------------------
#
# @class  RequirementsForMemberUnpaidForXMonths
#
...
#
#--------------------------
class RequirementsForMemberUnpaidForXMonths < AbstractRequirements
  ...
  # This user's membership has lapsed and the expiration date is exactly 6 months ago
